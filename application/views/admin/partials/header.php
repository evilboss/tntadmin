            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview<?php echo ($this->uri->segment(2) == "products") ? " active" : ""; ?>">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url('/admin/products'); ?>"><i class="fa fa-circle-o"></i> All</a>
                        </li>
                        <li><a href="<?php echo base_url('/admin/products/create'); ?>"><i class="fa fa-circle-o"></i>
                                Add</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview <?php echo ($this->uri->segment(2) == "producttype") ? " active" : ""; ?>">
                    <a href="#">
                        <i class="fa fa-list"></i>
