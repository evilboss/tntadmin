    ...
    <div class="row">
        <div class="col-xs-8">
            <div class="box box-info">
                ...
                <form data-validate method="POST" name="add_employee" action="<?= site_url('admin/pages/update') ?>"
                      validate>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                   value="<?php echo set_value('title', @$page['title']); ?>" placeholder="Enter Title">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug"
                                   value="<?php echo set_value('slug', @$page['slug']); ?>" placeholder="Enter slug">
                        </div>
