...
<script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v7.0&appId=731733500224472&autoLogAppEvents=1"
        nonce="G10zidkm"></script>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-4" style="padding-left:0;padding-right:0">
                                <a href="https://www.facebook.com/imaginarium.hobby/" target="_blank"><i
                                            class="fab fa-facebook"></i></a>
                                <div class="fb-page" data-href="https://www.facebook.com/annetteonlinestore/"
                                     data-tabs="timeline" data-width="" data-height="" data-small-header="false"
                                     data-adapt-container-width="true" data-hide-cover="false"
                                     data-show-facepile="true">
                                    <blockquote cite="https://www.facebook.com/annetteonlinestore/"
                                                class="fb-xfbml-parse-ignore"><a
                                                href="https://www.facebook.com/annetteonlinestore/">Annette &quot;Bautista&quot;
                                            Online Store</a></blockquote>
                                </div>
                                <!-- <a href="https://twitter.com/toyntoys/" target="_blank"><i class="fab fa-twitter"></i></a> -->
                                <a href="https://www.instagram.com/imaginarium.art/" target="_blank"><i
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="#"><img class="header-logo"
                                                         src="resources/img/logos/logo-imaginarium.png"></a>
                                    </div>
                                    <!--
                                                                    <div class="col-md-6">
                            ...
                            <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                                <li class="nav-item container-language">
                                    <a href="#" class="" title="settings">
                                        <select class="border-l border-r input-lg" id="shift_lang"
                                                onchange="shift_lang('http://47.52.67.37:8000/TNTWeb/');">
                                ...
                                <li class="dropdown nav-item ">
                                    <button type="button" id="dropdownMenu1" data-toggle="dropdown"
                                            class="btn dropdown-toggle">LOGIN <span class="caret"></span></button>
                                    <ul class="dropdown-menu dropdown-menu-right mt-2">
                                        <form>
                                            <div class="form-group">
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="color:#dde1e4"
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="exampleCheck1" style="color: #fff">Remember
                                                    Me</label>
                                                <a href=""><p style="float: right;color:#fff">I forgot my password</p>
                                                </a>
                                            </div>

                                            <div id="logitin" class="btn btn-danger"
                                                 style="width: 100%; margin-top: 10px;margin-bottom:10px">Login
                                            </div>
                                            ...
                                            <a href="<?= base_url('/shop/register') ?>" class="btn btn-primary"
                                               style="width: 100%;margin-bottom:10px">Sign Up</a>
                                        </form>
                                    </ul>
                                </li>
                                <li class="nav-item container-hearts"><a href="#" class=""><i
                                                class="fas fa-heart"></i><span id="heartCounter" class="bubble-notif2"
                                                                               style="display: none;">0</span></a></li>
                                <li class="nav-item container-shopcart"><a href="cart.php" class=""><i
                                                class="fas fa-shopping-cart"></i><span id="cartCounter"
                                                                                       class="bubble-notif3"
