<ul class="sidebar-menu">
    ...
    <?php if ($this->ion_auth->is_admin() || $this->ion_auth->is_super_admin()): ?>
        ...
        <li class="treeview <?= in_array($this->router->class, array('items')) ? ' active' : '' ?>">
            <a href="/">
            ...
            <ul class="treeview-menu">
                <li <?= $this->router->class == 'items' && $this->router->method == 'index' ? 'class="active"' : '' ?>>
                    <a
                            href="<?= site_url('items') ?>"><i class="fa fa-circle-o"></i>List Items</a></li>
            </ul>

        </li>
        <li class="treeview <?= in_array($this->router->class, array('order')) ? ' active' : '' ?>">
            <a href="/">
            ...
            <ul class="treeview-menu">
                <li <?= $this->router->class == 'order' && $this->router->method == 'index' ? 'class="active"' : '' ?>><a
                            href="<?= site_url('order') ?>"><i class="fa fa-circle-o"></i>List Orders</a></li>
            </ul>

        </li>
        <li class="treeview <?= in_array($this->router->class, array('settings', 'auth')) ? ' active' : '' ?>">
            <a href="/">
                <i class="fas fa-box"></i> <span>Shipping</span>
                <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
