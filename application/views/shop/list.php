                ...
                <div class="leftbar p-r-20 p-r-0-sm">
                    ...
                    <ul class="p-b-54">
                        ...
                        <?php foreach ($genres as $genre) : ?>
                            <li class="p-t-4">
                                <a href="<?php echo base_url('shop/' . $genre->id) ?>"
                                   class="s-text13 <?php echo ($this->uri->segment(2) == $genre->id) ? 'active1' : ''; ?>">
                                    <?php echo xss_clean($genre->name) ?>
                                </a>
                            </li>
                            <pre><?php print_r($genre); ?></pre>
                        <?php endforeach; ?>
